...
export const getStaticProps: GetStaticProps = async ({ locale }) => {
  return {
    props: {
      ...(await serverSideTranslations(locale, ["common", "feed"])),
    },
  };
};

const FeedLink = ({ children }) => <div className="mb-4">{children}</div>;
  ...
  return (
    <>
      ...
      <PaddedSection width="narrow" title={t("feedreader.sectionTitle")}>
        ...
        <h3 className="mb-2 text-xl">{t("feedreader.android")}</h3>
        <ul className="mb-6">
          <li>
            <a
        ...
        <h3 className="mb-2 text-xl">{t("feedreader.iOS")}</h3>
        <ul className="mb-6">
          <li>
            <a
        ...
        <h3 className="mb-2 text-xl">{t("feedreader.other")}</h3>
        <ul>
          <li>
